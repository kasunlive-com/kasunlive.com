...
const certifications = [
  { name: "Red Hat Certified Specialist in OpenShift Virtualization", status: "Reading" },
  { name: "Oracle Cloud Infrastructure Foundations 2020 Certified Associate", tag: "OCI-FAA" },
  { name: "Red Hat Certified Engineer", tag: "RHCE" },
  { name: "Red Hat Certified System Administrator", tag: "RHCSA" },
  { name: "AWS Certified Solutions Architect Associate", tag: "AWS-SAA" },
  { name: "Cisco Certified Network Professional", tag: "CCNP" },
  { name: "Cisco Certified Network Associate", tag: "CCNA" },
  { name: "The Fundamentals of Digital Marketing", tag: "Google" },
];
